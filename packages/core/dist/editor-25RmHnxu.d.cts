import { DocEdits, DocQueries, DocQueryResults, ContentControlSummary } from './contracts/document.cjs';
import { g as ReviewRevisionKind, c as ReviewCommentItem, b as ReviewRevisionItem, d as ReviewCustomItem } from './review-support-rsyGP5-9.cjs';
import { a as SemanticSelection, S as SemanticPosition } from './semantic-interaction-B4HrJFQ2.cjs';
import { ExecErrorCode, ColorValue, Watermark, DocAnchor, ExecResult, ContentControlFilter, DocRange, RunFormatting, Revision, Rect, Unsubscribe } from './contracts/types.cjs';
import { S as SourceCrop, b as ImageWrapTarget, c as DrawingKind, d as DrawingPositionInput, e as DrawingLocks } from './tree-op-types-UOXlRUqQ.cjs';
import { S as SupportedImageMime, I as ImageResourceState } from './image-resources-DwpNnTg3.cjs';
...
declare function cropPermilleFromCropPercent(crop: ImageCropPercent): ImageCropPermille;
/** Permille crop → UI percent. */
declare function cropPercentFromCropPermille(crop: ImageCropPermille): ImageCropPercent;
/**
...
export { type NotePropertiesState as $, type AuthoredNoteNumbering as A, type EditorNoteCommands as B, type CanResult as C, type DocumentSource as D, EditorFontError as E, type FontConfiguration as F, type EditorPosition as G, type EditorQueries as H, type ImageContext as I, type EditorQuery as J, type EditorQueryResults as K, type EditorScope as L, type EditorSelection as M, type EditorSnapshot as N, type FurnitureVariant as O, type HeaderFooterSlotArgs as P, type HeaderFooterState as Q, type HyperlinkInfo as R, type SelectedImageState as S, type TableBorderEdgeTarget as T, type InteractionAffinity as U, type ViewScope as V, type InteractionOutcome as W, type InteractionOutcomeCode as X, type NoteKind as Y, type ZoomMode as Z, type NotePropertiesSide as _, type EditorCommand as a, type PageSetup as a0, type ResolvedNoteNumbering as a1, type ReviewActivationOptions as a2, type ReviewCommentPlacement as a3, type ReviewCustomPlacement as a4, type ReviewItemPlacement as a5, type ReviewItemPlacementBase as a6, type ReviewItemQuery as a7, type ReviewRevisionPlacement as a8, type SemanticIdentity as a9, type SemanticTarget as aa, type TableBorderTarget as ab, type TableCellVerticalAlignment as ac, type TableColumnDividerResizeTarget as ad, type TableColumnOccurrenceTarget as ae, type TableRightEdgeResizeTarget as af, type TableRowOccurrenceTarget as ag, type TextMatch as ah, type ZoomFitTarget as ai, type ImageCropPercent as b, type ImageCropPermille as c, cropPercentFromCropPermille as d, cropPercentFromPermille as e, cropPercentFromSourceCrop as f, cropPermilleFromCropPercent as g, cropPermilleFromPercent as h, type FontSource as i, type FontSourceSubstitution as j, type FontFaceRequest as k, type Editor as l, type TableBorderSpec as m, type TableBorderStyle as n, type TableContext as o, type DocumentChange as p, type DocumentEditingMode as q, type DocumentHandle as r, sourceCropFromCropPercent as s, type EditorCommandShape as t, type EditorCommands as u, validateImageCropPercent as v, type EditorError as w, type EditorEvents as x, type EditorFontErrorCode as y, type EditorHeaderFooterCommands as z };
