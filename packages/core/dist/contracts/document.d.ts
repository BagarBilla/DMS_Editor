import { DocxDocument, ExecResult, ContentControlType, DocTarget, RunFormatting, Extent, ContainerRef, ContentControlFilter, DocRange, Revision, DocComment, StyleDefinitions } from './types.js';
export { Block, ColorValue, ContentControl, DocAnchor, DocAnchorRange, DocLocation, DocumentBody, ExecErrorCode, HeaderFooterSet, IndentFormatting, Paragraph, RevisionType, Section, SectionProperties, StyleDefinition, Table, Theme, ThemeColorScheme } from './types.js';
...
export { type ApplyResult, ContainerRef, ContentControlFilter, type ContentControlSummary, ContentControlType, DocComment, type DocEdit, type DocEdits, type DocQueries, type DocQuery, type DocQueryResults, DocRange, DocTarget, DocxDocument, ExecResult, Extent, type ParagraphSummary, Revision, RunFormatting, StyleDefinitions };
