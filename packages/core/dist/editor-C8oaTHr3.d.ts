import { DocEdits, DocQueries, DocQueryResults, ContentControlSummary } from './contracts/document.js';
import { g as ReviewRevisionKind, c as ReviewCommentItem, b as ReviewRevisionItem, d as ReviewCustomItem } from './review-support-B9ykYpoZ.js';
import { a as SemanticSelection, S as SemanticPosition } from './semantic-interaction-unGpRNCk.js';
import { ExecErrorCode, ColorValue, Watermark, DocAnchor, ExecResult, ContentControlFilter, DocRange, RunFormatting, Revision, Rect, Unsubscribe } from './contracts/types.js';
import { S as SourceCrop, b as ImageWrapTarget, c as DrawingKind, d as DrawingPositionInput, e as DrawingLocks } from './tree-op-types-DWLCllG7.js';
import { S as SupportedImageMime, I as ImageResourceState } from './image-resources-C_YnqPhn.js';
