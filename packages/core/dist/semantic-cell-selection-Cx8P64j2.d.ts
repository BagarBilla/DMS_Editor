import { e as OoxmlPart, a as OoxmlElement, O as OoxmlNode } from './ooxml-tree-BU0e3DVi.js';
import { P as PageGeometry, I as InlineDrawingRecord, A as AnchoredDrawingRecord, T as TextMeasurer, L as LineRecord, S as SemanticLayout, C as ContentControlBoundaryRecord, a as StyleSpanRecord, b as TableRowFragmentRecord, c as TableCellFragmentRecord } from './semantic-records-BC4bIKKL.js';
import { R as RevisionDisplayMode } from './revision-projection-DHAkcD_L.js';
import { S as SemanticPosition, C as CaretGeometry, a as SemanticSelection } from './semantic-interaction-unGpRNCk.js';
