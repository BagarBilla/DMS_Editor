import { i as FontSource, j as FontSourceSubstitution, F as FontConfiguration, k as FontFaceRequest, I as ImageContext, D as DocumentSource, Z as ZoomMode, E as EditorFontError, l as Editor, a as EditorCommand, C as CanResult, S as SelectedImageState, V as ViewScope, T as TableBorderEdgeTarget, m as TableBorderSpec, n as TableBorderStyle, o as TableContext } from './editor-C8oaTHr3.js';
import { T as TreeDocOp, d as DrawingPositionInput, k as DrawingTransform, m as DrawingTreeDocOp } from './tree-op-types-DWLCllG7.js';
import { b as ImageDecodePort, S as SupportedImageMime } from './image-resources-C_YnqPhn.js';
import { R as RevisionDisplayMode } from './revision-projection-DHAkcD_L.js';
import './review-support-B9ykYpoZ.js';
import { a as SemanticSelection, S as SemanticPosition, N as NavigationCommand } from './semantic-interaction-unGpRNCk.js';
import { R as ResolvedFootnoteProperties, a as ResolvedEndnoteProperties, A as AuthoredNoteProperties, l as ReviewRevisionKind } from './review-reads-CMAqdMnE.js';
import { S as SemanticLayout, C as ContentControlBoundaryRecord, T as TextMeasurer } from './semantic-records-BC4bIKKL.js';
import { S as StoryScope, A as ApplyImagePropertiesInput, d as ImageIntentResult, c as InsertImageInput, B as BookmarkIndex } from './custom-node-writes-ttKuYd0M.js';
import { C as CellSelection, S as SectionProperties } from './semantic-cell-selection-Cx8P64j2.js';
import { EditorModule, ReviewModuleContribution } from './contracts/modules.js';
import { Unsubscribe, ExecResult, IndentFormatting } from './contracts/types.js';
import { F as FieldShadingMode, a as DrawingPaintStrings } from './semantic-paint-BBNaqr1s.js';
import { T as TreeDocxSession, a as TreeApplyResult } from './tree-session-CMA7n4Rm.js';
