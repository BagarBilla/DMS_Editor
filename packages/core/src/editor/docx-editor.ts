...
import { resolveEditorModules, type ReviewModelInput } from '../contracts/modules.js';
import {
...
import { parseNoteScopeId } from '../store/package/note-nodes.js';
...
import { execEditorCommand } from './docx-editor-exec.js';
import {
...
import { availableFontFamilies, configuredDefaultFontFamily } from './font-catalog.js';
import { embeddedFontSources } from './embedded-font-sources.js';
import { createLocalFontProbe, detectFontSubstitutions } from './font-availability.js';
...
import { drawingPaintStringsFromTranslate } from '../output/semantic-paint-drawings.js';
import { surfaceScroller } from './surface-pages.js';
import { createZoomLane, zoomFacadeMembers } from './docx-editor-zoom.js';
import type {
  DocxEditorConfig,
  DocxEditorInstance,
  HyperlinkChromeHandlers,
} from './docx-editor-types.js';
