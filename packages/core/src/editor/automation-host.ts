...
import type { AutomationCapabilities, AutomationHost } from '../automation/index.js';
import type {
  AutomationCommentWriteResult,
  AutomationDocumentPort,
  AutomationPortApplyResult,
  AutomationStagedOps,
} from '../automation/document-port.js';
import { createAutomationHost } from '../automation/host.js';
...
import type { TreeDocxSession } from '../binding/tree-session.js';
