...
import { wmlAttributeValue } from '../store/store/tree-op-table-shared.js';
...
import type { BlockFragmentRecord, TableFragmentRecord } from '../layout/semantic-records.js';
import type { CellSelection } from '../layout/semantic-cell-selection.js';
import type { SurfaceEditingMode } from './paginated-surface-contract.js';
import {
  planTableCommand,
  planTableRowHeightResize,
  type TableCommandPlan,
} from './table-command-plan.js';
import { pageAtY } from '../layout/semantic-hit-test.js';
import {
...
} from '../layout/semantic-table-interaction.js';
import type {
...
import type { TableInteractionLabelKey } from './table-chrome.js';
...
export type { TableInteractionLabelKey } from './table-chrome.js';
...
export interface SurfaceTableInteractionInput {
  ...
  readonly themeColors: readonly import('../binding/document-theme.js').DocumentThemeColorEntry[];
}
