...
import type { EditorCommand, ExecResult } from '../contracts/editor.js';
import type { PaginatedSurface } from './paginated-surface-contract.js';
import { writeClipboardText } from './clipboard-write.js';
import { MARKS, isSurfaceSelection, resolveMarkAttr } from './docx-editor-support.js';
import { isDocAnchor, isDocAnchorRange, resolveAnchorSelection } from './anchor-resolution.js';
import {
...
} from './docx-editor-notes.js';
import { isTableEditorCommand, planTableCommand } from './table-command-plan.js';
import { execImageCommand, isImageCommand } from './docx-editor-images.js';
...
export function execEditorCommand(
  ...
  options?: {
    readonly admittedTablePlan?: import('./table-command-plan.js').TableCommandPlan;
    readonly editor?: Pick<
      import('./docx-editor-types.js').DocxEditorInstance,
