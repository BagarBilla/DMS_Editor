...
import type { DocumentThemeColorEntry } from '../binding/document-theme.js';
import type { OoxmlPart } from '../store/package/ooxml-tree.js';
import type { OoxmlTableCellNode } from '../store/package/ooxml-tree.js';
import { validateTreeOp } from '../store/store/tree-ops.js';
import {
  readEditableTableTopology,
  type EditableTableTopology,
} from '../store/store/tree-op-table-topology.js';
import { wmlAttributeValue, wmlChildNamed } from '../store/store/tree-op-table-shared.js';
import {
  MAX_TABLE_COLUMNS,
  MAX_TABLE_BORDER_SIZE_EIGHTHS,
  MIN_TABLE_BORDER_SIZE_EIGHTHS,
  MIN_TABLE_COLUMN_WIDTH_TWIPS,
} from '../store/store/table-constraints.js';
import { tableAnchorAt } from '../layout/semantic-cell-selection.js';
import type { CellSelection } from '../layout/semantic-cell-selection.js';
import type { SemanticLayout } from '../layout/semantic-records.js';
import type { SemanticSelection } from '../layout/semantic-interaction.js';
import type {
  TableColumnOccurrenceTarget,
  TableRowOccurrenceTarget,
} from '../layout/table-interaction-targets.js';
import { lowerColorValueForBorder, lowerColorValueForFill } from './color-value-lower.js';
import type {
  ...
  TreeDocOp,
  TreeOpRejection,
} from '../store/store/tree-op-types.js';
import { TABLE_BORDER_STYLES } from '../store/table-border-style.js';
