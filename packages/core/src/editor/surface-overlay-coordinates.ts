...
import type { ImageInteractionSession, ImageResizeHandle } from './docx-editor-images.js';
import { EMU_PER_POINT, pointsToEmu, computeMovedImagePosition } from './docx-editor-images.js';
