...
import { mountPaginatedSurface, type PaginatedSurface } from '../paginated-surface.js';
import { validateRasterHeader, type ImageDecodePort } from '../../store/package/image-resources.js';
import { resolveImageResourceLimits } from '../../store/runtime/limits.js';
import type { BlockFragmentRecord, PageRecord } from '../../layout/semantic-records.js';
