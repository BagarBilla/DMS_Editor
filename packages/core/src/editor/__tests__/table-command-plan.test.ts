...
import { tableCommandState } from '../docx-editor-derive.js';
...
import { diffSemanticDigests, semanticDigest } from '../../store/package/ooxml-digest.js';
import { wmlChildNamed } from '../../store/store/tree-op-table-shared.js';
import { MAX_TABLE_COLUMNS } from '../../store/store/table-constraints.js';
