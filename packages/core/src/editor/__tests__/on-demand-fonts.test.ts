...
import type { EditorFontError } from '../../contracts/editor.js';
import { sha256FontBytes } from '../../layout/index.js';
import { createDocxEditor, type DocxEditorInstance } from '../docx-editor.js';
import { MAX_RESOLVER_FAMILIES, type FontResolutionRequest } from '../font-composition.js';
import { docx } from './paginated-surface-fixtures.js';
