...
import { tableRowOccurrenceTargetFrom } from '../../layout/table-interaction-targets.js';
import { visitTableOccurrences } from '../../layout/table-interaction-targets.js';
import { paragraphTextOf } from '../../store/store/tree-ops.js';
import { MAX_TABLE_COLUMNS } from '../../store/store/table-constraints.js';
import { CHROME_GROUPS, chromeSlotId } from '../chrome-controls.js';
import { GENERATED_ICON_PATHS } from '../generated-icon-paths.js';
