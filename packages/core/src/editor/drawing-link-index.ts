...
import type { HeaderFooterStoryRecord, PageRecord } from '../layout/semantic-records.js';
import type { SurfaceHyperlink } from './surface-hyperlinks.js';
...
function visitBlockDrawings(
  block:
    | import('../layout/semantic-records.js').ParagraphFragmentRecord
    | import('../layout/semantic-records.js').TableFragmentRecord,
  drawingNodeId: string
): SurfaceHyperlink | null {
  if (block.kind === 'table') {
