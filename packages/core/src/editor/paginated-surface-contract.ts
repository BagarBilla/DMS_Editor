...
import type { RevisionDisplayMode } from '../layout/revision-projection.js';
import type { FieldShadingMode } from '../output/semantic-paint.js';
import type { ReviewModuleContribution } from '../contracts/modules.js';
import type { HyperlinkOps } from './surface-hyperlinks.js';
import type { HyperlinkActivation, SurfaceNavigation } from './surface-navigation.js';
import type {
  CellSelection,
...
export interface PaginatedSurfaceOptions {
  ...
  readonly drawingStrings?: import('../output/semantic-paint-drawings.js').DrawingPaintStrings;
  /** Override raster decode for package image intents; defaults to browser/headless. */
  readonly imageDecodePort?: import('../store/package/image-resources.js').ImageDecodePort;
  /**
...
export interface PaginatedSurface {
  ...
  imageDecodePort(): import('../store/package/image-resources.js').ImageDecodePort;
  applyDrawingOps(
    ops: readonly import('../store/store/tree-op-types.js').DrawingTreeDocOp[]
  ...
  insertImage(
    input: Omit<import('../store/store/tree-package-images.js').InsertImageInput, 'decodePort'>
   ...
   */
  overlayCoordinates(): import('./surface-overlay-coordinates.js').SurfaceOverlayCoordinates;
  /**
  ...
  notePropertiesState(): import('./surface-note-state.js').NotePropertiesStateSnapshot | null;
  ...
  applyTableCommandPlan(
    plan: import('./table-command-plan.js').TableCommandPlan
  ): import('../contracts/editor.js').ExecResult;
}
