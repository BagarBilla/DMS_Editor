...
export {
  ...
  type FontResolver,
} from './font-composition.js';
export { blankDocumentBytes } from './blank-document.js';
export {
  createFontSource,
  loadFonts,
...
export { tableCommandState } from './docx-editor-derive.js';
export {
...
export type { FontMeasurementState } from './docx-editor-types.js';
...
export { BROWSER_AUTOMATION_CAPABILITIES, createBrowserAutomationHost } from './automation-host.js';
...
} from './color-value-lower.js';
export type { ColorLowerResult } from './color-value-lower.js';
export {
...
} from './docx-editor-images.js';
export { surfaceExtent, type SurfaceExtent } from './surface-pages.js';
...
} from './surface-overlay-coordinates.js';
export {
  IMAGE_WRAP_TARGETS,
  type ImageWrapTarget,
  type DrawingPositionInput,
} from '../store/package/drawing-projection.js';
export {
  DRAWING_REL_FROM_H,
  DRAWING_REL_FROM_V,
...
} from '../store/package/drawing-position-input.js';
export {
...
} from '../store/package/image-crop-units.js';
export {
...
} from '../store/package/image-resources.js';
export {
  DEFAULT_IMAGE_RESOURCE_LIMITS,
  resolveImageResourceLimits,
  type ImageResourceLimits,
} from '../store/runtime/limits.js';
export type { HyperlinkOps, SurfaceHyperlink } from './surface-hyperlinks.js';
export type { HyperlinkActivation, SurfaceNavigation } from './surface-navigation.js';
...
export type { FieldShadingMode } from '../output/semantic-paint.js';
