...
import type { ChromeSlotId } from './chrome-controls.js';
...
import { IMAGE_WRAP_TARGETS, type ImageWrapTarget } from '../store/package/drawing-projection.js';
...
export { DEFAULT_TABLE_CHROME_DRAFT } from './table-chrome.js';
