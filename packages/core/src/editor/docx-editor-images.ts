...
import { lineAtPosition } from '../layout/index.js';
import type { AnchoredDrawingRecord, InlineDrawingRecord } from '../layout/drawing-layout.js';
import { findDrawingOverlayFrameInLayout } from '../layout/semantic-hit-test.js';
...
import { sanitizeHref } from '../store/package/sinks.js';
import type { SupportedImageMime } from '../store/package/image-resources.js';
import {
...
import type { DrawingTreeDocOp } from '../store/store/tree-op-types.js';
import type { DocxEditorInstance } from './docx-editor-types.js';
import type { PaginatedSurface } from './paginated-surface-contract.js';
...
function projectDrawingForRecord(
  ...
  return projectDrawing(drawing as import('../store/package/ooxml-tree.js').OoxmlDrawingNode, {
