...
import type { VectorShapeProjection } from '../../store/package/drawing-projection.js';
import { computeDrawingGeometry } from '../../layout/drawing-geometry.js';
import { EMU_PER_POINT, type InlineDrawingRecord } from '../../layout/drawing-layout.js';
import { DEFAULT_DRAWING_PAINT_STRINGS, paintDrawingRecord } from '../semantic-paint-drawings.js';
