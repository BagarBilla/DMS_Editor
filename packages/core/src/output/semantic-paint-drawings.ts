...
import type { DrawingPoint } from '../layout/drawing-geometry.js';
import { cssTransformForDrawingImage } from '../layout/drawing-geometry.js';
import type {
  LayoutBox,
  ParagraphFragmentRecord,
  TableFragmentRecord,
} from '../layout/semantic-records.js';
import type { SemanticLayout } from '@docx-editor.dev/core/layout';
import { paintLayerOf } from '../layout/drawing-exclusion.js';
