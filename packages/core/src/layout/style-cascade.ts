...
import { isDangerousKey } from '../store/package/safe-record.js';
import {
  indentTwips,
  paragraphAlignment,
  paragraphIndent,
...
import { paragraphShading } from './ooxml-shading.js';
import {
  cascadedTabStops,
  paragraphTabStops,
  tabStopsFingerprint,
...
import type { ThemeFonts } from './run-style.js';
...
export interface ParagraphLayoutInputs {
  ...
  readonly listItem?: import('./list-resolve.js').ResolvedListItem;
}
...
export function resolveParagraphLayoutInputs(
  ...
  listItem?: import('./list-resolve.js').ResolvedListItem,
  tableCellStyle?: TableCellStyleFormatting,
  inTableCell = false
