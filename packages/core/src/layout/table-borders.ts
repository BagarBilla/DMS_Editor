...
} from './border-metrics.js';
import { MAX_BORDER_WIDTH_PT } from './paragraph-style.js';
import { resolveStrictHexFill } from './ooxml-shading.js';
import { effectiveBorderSide } from './table-border-cascade.js';
import {
  buildColumnOwnershipIndexes,
  ownerAt,
  type TableBorderGridResolveWork,
  type TableBorderOwnershipBudget,
} from './table-border-ownership.js';
...
export { effectiveBorderSide } from './table-border-cascade.js';
export {
