...
import { collectNoteReferences } from '../store/package/note-references.js';
import type { DocumentSection } from './section-properties.js';
...
import { formatNumFmt } from './numbering-format.js';
import {
...
import { noteMarkKey, type NoteMarkContext } from './note-projection.js';
import type {
  BlockFragmentRecord,
  LineRecord,
  NoteAreaRecord,
...
import { cascadeRunProperties, type StyleCascadeTable } from './style-cascade.js';
import { DEFAULT_RUN_STYLE, resolveRunStyle, type ResolvedRunStyle } from './run-style.js';
import { finalizePageFieldProjection } from './field-projection.js';
