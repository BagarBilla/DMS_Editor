...
import { stableHash } from '../store/comparators/canonical.js';
import { canonicalOoxmlFingerprint } from '../store/package/ooxml-tree.js';
import {
...
import type { ParagraphLayoutCache } from './layout-cache.js';
import type { PendingLine } from './paragraph-flow.js';
import type { RevisionDisplayMode } from './revision-projection.js';
import type { AnchoredDrawingRecord } from './drawing-layout.js';
import { pageClipRegion, type DrawingAnchorFrameContext } from './drawing-layout.js';
import {
...
import { flowBlocksInBox } from './semantic-table-layout.js';
...
import type { StyleCascadeTable } from './style-cascade.js';
...
export function layoutHeaderFooterStory(
  ...
  inlineDrawingLayout?: import('./drawing-layout.js').InlineDrawingLayoutContext,
...
export function remapPage(page: PageRecord, globalIndex: number, sheetY: number): PageRecord {
  ...
  const shiftNoteArea = (
    area: import('./semantic-records.js').NoteAreaRecord | undefined
  ): import('./semantic-records.js').NoteAreaRecord | undefined => {
