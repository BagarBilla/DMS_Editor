...
import type { LayoutBox, StyleSpanRecord, TextMeasurer } from './semantic-records.js';
import {
...
interface Piece {
  ...
  readonly link?: import('./semantic-records.js').SpanLinkRecord;
  /** Typed inline drawing occupying one UTF-16 model unit. */
  readonly inlineDrawing?: import('./drawing-layout.js').InlineDrawingLayoutInput;
}
