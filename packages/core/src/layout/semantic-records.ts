...
import type { TabLeader } from './paragraph-tabs.js';
import type { FieldAtomMarker, ModelRange } from './field-pieces.js';
import type { InlineDrawingRecord, AnchoredDrawingRecord } from './drawing-layout.js';
import type { RevisionAttribution } from './revision-projection.js';
import type { ResolvedRunStyle } from './run-style.js';
import type { ResolvedCellBorders } from './table-borders.js';
...
export type { TabLeader } from './paragraph-tabs.js';
export type {
  ResolvedCellBorders,
