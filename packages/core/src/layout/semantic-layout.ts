...
import { WML_MAIN_DOCUMENT_PART } from '../store/package/opc-names.js';
import {
...
import { paragraphLayoutKey, type ParagraphLayoutCache } from './layout-cache.js';
import {
  alignSpans,
  alignDrawings,
  breakParagraph,
...
import { resolveParagraphBorders } from './paragraph-border-resolve.js';
import {
  adjustedBreakIndex,
  keepNextFlowKeys,
  keepNextGroupHeight,
  ...
  MAX_KEEP_NEXT_CHAIN,
  type ParagraphKeeps,
} from './pagination-keeps.js';
import { DEFAULT_RUN_STYLE, resolveRunStyle } from './run-style.js';
import {
  tabStopsFingerprint,
...
import { paragraphShadingBox } from './ooxml-shading.js';
import {
  readTableStructure,
  tableFloatOriginX,
  tableOriginX,
...
import { annotateTableFragmentGeometry } from './semantic-table-interaction.js';
import { storyBlocks } from './story-roots.js';
import type { InlineDrawingLayoutContext } from './drawing-layout.js';
import {
...
} from './drawing-exclusion.js';
import { drawingModelOffsetsInParagraph } from './drawing-layout.js';
import { drawingResourceLayoutToken, drawingTokenForTableBlock } from './inline-drawing-source.js';
import { projectDrawingsInPart } from '../store/package/drawing-projection.js';
import {
  emptyTocPlaceholderParagraphIds,
  emptyTocSuppressedResultParagraphIds,
  tocFieldChromeParagraphIds,
} from './toc-layout.js';
import { type HeaderFooterStoryLayout } from './hf-layout.js';
import {
...
import { resolveSectionColumns, type ResolvedSectionColumns } from './section-columns.js';
import { layoutSemanticDocumentWithNotes } from './note-pagination.js';
import {
...
import type { NumberingIndex } from './numbering-index.js';
import { firstLineShift, withResolvedListItems, type ResolvedListItem } from './list-resolve.js';
import { publishListMarker } from './list-marker.js';
import { sameFragments, sameAnchoredDrawings } from './semantic-fragment-signature.js';
import { type FlowCheckpoint, type LayoutSession } from './layout-session.js';
import { furnitureForSection, layoutMultiSectionDocument } from './multi-section-layout.js';
import { layoutTextboxStory } from './textbox-story-layout.js';
...
export interface SemanticLayoutOptions {
   ...
   */
  readonly notes?: import('./note-pagination.js').NotesLayoutInput;
  /**
  ...
  readonly noteMarks?: import('./note-projection.js').NoteMarkContext;
...
function layoutBlocksPass(
  ...
  const furnitureFor = (
    ...
    const pageContext: import('./field-projection.js').FieldPageContext = {
      pageNumber,
  ...
  const layoutTextboxStoryForBody = (
    projection: import('../store/package/drawing-projection.js').DrawingProjection
  ) =>
