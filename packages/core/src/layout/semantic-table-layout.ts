...
import type { FieldPageContext, HyperlinkProjector } from './field-projection.js';
import { paragraphLayoutKey, type ParagraphLayoutCache } from './layout-cache.js';
import { alignDrawings, alignSpans, breakParagraph, type PendingLine } from './paragraph-flow.js';
import type { RevisionDisplayMode } from './revision-projection.js';
import {
  collapsedSpaceBefore,
  paragraphBorderExtentPt,
  paragraphBorderStrokeWidthPt,
} from './paragraph-style.js';
import { tabStopsFingerprint, withDefaultTabInterval } from './paragraph-tabs.js';
import { DEFAULT_RUN_STYLE } from './run-style.js';
import {
...
import { firstLineShift, type ResolvedListItem } from './list-resolve.js';
...
export interface TableFlowDeps {
  ...
  readonly inlineDrawingLayout?: import('./drawing-layout.js').InlineDrawingLayoutContext;
  ...
  ) => import('./textbox-story-layout.js').TextboxStoryLayout | null;
  readonly pageContentClip?: () => import('./semantic-records.js').LayoutBox;
  ...
  readonly columnBoxForParagraph?: (
    paragraphBox: import('./semantic-records.js').LayoutBox
  ) => import('./semantic-records.js').LayoutBox;
  ...
  readonly pageExclusionZones?: () => readonly import('./drawing-exclusion.js').ExclusionZone[];
