...
import { PAGE_BREAK_CHAR } from '../store/package/hard-break.js';
import { graphemeBoundaryEpoch, segmentGraphemes } from './grapheme.js';
import { baselineShiftPtOf, measureDisplayText } from './run-style.js';
import type { CaretGeometry, SemanticPosition } from './semantic-interaction.js';
import type {
  BlockFragmentRecord,
...
import { pointInDrawingClip } from './drawing-wrap.js';
