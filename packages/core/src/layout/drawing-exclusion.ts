...
import type { DrawingProjection, ImageWrapTarget } from '../store/package/drawing-projection.js';
import {
...
import { drawingGeometryFromProjection } from './drawing-geometry.js';
import type { OoxmlNode } from '@docx-editor.dev/core/store';
import type { DrawingGeometry } from './drawing-geometry.js';
import {
...
export function collectExclusionZonesFromDrawings(
  drawings: readonly AnchoredDrawingRecord[],
  drawingLayout: import('./drawing-layout.js').InlineDrawingLayoutContext,
  contentLeft: number,
  contentRight: number,
...
export function collectExclusionZonesByPage(
  pages: readonly import('./semantic-records.js').PageRecord[],
  drawingLayout: import('./drawing-layout.js').InlineDrawingLayoutContext,
  contentWidth: number,
  sourceOrderOf?: (drawingNodeId: string) => number | undefined,
  columnLayout?: ExclusionColumnLayout
