...
import { readTableStructure, tableOriginX } from '../semantic-table.js';
import { revisionRemovesParagraph } from '../revision-visibility.js';
import { createFixedMeasurer, layoutSemanticDocument } from '../semantic-layout.js';
import type { ParagraphFragmentRecord, TableFragmentRecord } from '../semantic-records.js';
