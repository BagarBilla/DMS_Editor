...
import {
  ...
  type OoxmlPart,
} from '../../store/package/ooxml-tree.js';
import {
...
import { breakParagraph } from '../paragraph-flow.js';
import { hitTestPage } from '../semantic-hit-test.js';
import { caretAt, moveCaret } from '../semantic-interaction.js';
import { createFixedMeasurer, layoutSemanticDocument } from '../semantic-layout.js';
import { linesOf, paragraphFragmentsOf, type PageGeometry } from '../semantic-records.js';
...
function drawingOf(part: OoxmlPart): OoxmlDrawingNode {
  const stack: import('../../store/package/ooxml-tree.js').OoxmlElement[] = [part.root];
...
function anchorFrameContext(
  overrides: Partial<import('../drawing-layout.js').DrawingAnchorFrameContext> = {}
) {
