...
import { reprojectBodyNoteMarks } from '../note-pagination.js';
import { paintSemanticLayout } from '../../output/semantic-paint.js';
import type { BlockFragmentRecord, SemanticLayout, StyleSpanRecord } from '../semantic-records.js';
import { noteMarkKey } from '../note-projection.js';
