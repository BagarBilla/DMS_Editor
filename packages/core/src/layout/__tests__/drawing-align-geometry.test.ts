...
import { readOoxmlPart, WML_NAMESPACE_URI } from '../../store/index.js';
import {
  DEFAULT_DRAWING_PROJECTION_LIMITS,
  indexInlineDrawingProjectionsInPart,
  projectDrawing,
} from '../../store/package/drawing-projection.js';
import { createFixedMeasurer, layoutSemanticDocument } from '../index.js';
import { linesOf } from '../semantic-records.js';
import type { InlineDrawingLayoutContext, InlineDrawingRecord } from '../drawing-layout.js';
...
function layoutOf(xml: string) {
  ...
  const inlineDrawingLayout: InlineDrawingLayoutContext = Object.freeze({
    ...
    project: (node: import('../../store/package/ooxml-tree.js').OoxmlDrawingNode) =>
