...
import { readOoxmlPart, type OoxmlPart } from '../../store/package/ooxml-tree.js';
import { applyTreeOp } from '../../store/store/tree-ops.js';
import { createParagraphLayoutCache } from '../layout-cache.js';
import type { PendingLine } from '../paragraph-flow.js';
import { caretStops, documentOrder, paragraphTextFromLayout } from '../semantic-interaction.js';
import {
  createFixedMeasurer,
  createLayoutSession,
  layoutSemanticDocument,
} from '../semantic-layout.js';
import { MAX_TABLE_COLUMNS } from '../semantic-table.js';
import { TablePaginationError } from '../semantic-table-layout.js';
import {
...
describe('incremental layout with tables', () => {
  ...
  function editCellParagraph(part: OoxmlPart, needle: string, text: string): OoxmlPart {
    const findParagraph = (
      node: import('../../store/package/ooxml-tree.js').OoxmlNode
    ): string | null => {
