...
import { resolveNotesPart, collectNoteReferences } from '../../store/package/note-references.js';
import {
...
import { DEFAULT_NOTE_SEPARATOR_HEIGHT_PT, layoutNoteSeparator } from '../note-layout.js';
import {
  enumerateDocumentSections,
  enumerateDocumentSectionsBounded,
  MAX_DOCUMENT_SECTIONS,
} from '../section-properties.js';
import type { PageRecord, ParagraphFragmentRecord } from '../semantic-records.js';
