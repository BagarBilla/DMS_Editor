...
import type { DrawingTransform, SourceCrop } from '../store/package/drawing-projection.js';
import { DEFAULT_IMAGE_RESOURCE_LIMITS } from '../store/runtime/limits.js';
import { EMU_PER_POINT, emuToPointsSafe } from './drawing-layout.js';
...
export { pointInDrawingClip } from './drawing-wrap.js';
...
export function drawingGeometryFromProjection(options: {
  readonly projection: import('../store/package/drawing-projection.js').DrawingProjection;
  readonly anchorX: number;
  readonly anchorY: number;
  readonly extentWidth: number;
  readonly extentHeight: number;
