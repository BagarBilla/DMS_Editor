...
import type { AutomationErrorCode } from './protocol.js';
import type { AutomationPackageReads } from './reads.js';
import { resolvePoint, resolveSpanRef, type ResolvedRange } from './spans.js';
import {
