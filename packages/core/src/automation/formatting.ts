...
import type { OoxmlElement, OoxmlPart } from '../store/package/ooxml-tree.js';
import { isValidXmlText } from '../store/package/sinks.js';
import {
...
import {
  ...
  runPropertiesNodeOf,
} from '../store/store/tree-op-nodes.js';
import { paragraphStyleName, styleIdFor, type AutomationStyleIndex } from './styles.js';
import type { OoxmlProperty } from '../store/store/tree-ops.js';
