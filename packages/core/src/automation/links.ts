...
import {
  ...
  hyperlinkTargetOf,
  isHyperlinkNode,
} from '../store/package/hyperlink.js';
import { relationshipTargetIn } from '../store/package/hyperlink-part.js';
import type { OoxmlPackage } from '../store/package/ooxml-package.js';
import { WML_NAMESPACE_URI } from '../store/package/ooxml-shared.js';
import type { OoxmlNode } from '../store/package/ooxml-tree.js';
import { paragraphOffsetIndex } from '../store/store/tree-op-segments.js';
import type { AutomationStoryReads } from './reads.js';
