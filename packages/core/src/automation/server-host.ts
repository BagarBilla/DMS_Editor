...
} from '../store/package/ooxml-package.js';
import { ensureHyperlinkRelationship } from '../store/package/hyperlink-part.js';
import { normalizeParagraphIdentity } from '../store/package/para-id.js';
import { TreePackageStore, type StoryScope } from '../store/store/tree-package-store.js';
import type { TreeDocOp } from '../store/store/tree-ops.js';
import { addComment, setCommentResolved } from '../store/store/comment-writes.js';
import { insertCustomNodeWrite } from '../store/store/custom-node-writes.js';
import type {
...
import { createAutomationHost } from './host.js';
import type { AutomationCapabilities, AutomationHost } from './protocol.js';
