...
} from '../store/package/hf-references.js';
import {
  findNoteById,
  isNormalNote,
  noteIdOf,
  notesOf,
  type NoteKind,
} from '../store/package/note-nodes.js';
import { resolveNotesPart } from '../store/package/note-references.js';
import { paraIdOf } from '../store/package/para-id.js';
import type { OoxmlPackage } from '../store/package/ooxml-package.js';
import type { OoxmlNode, OoxmlPart } from '../store/package/ooxml-tree.js';
import {
  bodyStoryRoot,
  collectStoryParagraphs,
  storyParagraphs,
} from '../store/package/story-blocks.js';
import { namedChild, paragraphPropertiesNodeOf } from '../store/store/tree-op-nodes.js';
import { paragraphTextOf } from '../store/store/tree-ops.js';
import type { StoryScope } from '../store/store/tree-package-store.js';
import { sectionReads, type AutomationSectionRead } from './sections.js';
import { styleIndex, type AutomationStyleIndex } from './styles.js';
import { BODY_STORY, HEADER_FOOTER_VARIANTS, storyKey, type AutomationStoryId } from './stories.js';
