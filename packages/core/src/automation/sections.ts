...
import type { HeaderFooterSectionResolution } from '../store/package/hf-references.js';
import { collectSectionPropertyNodes } from '../store/package/hf-references.js';
...
import { metricsOfSection } from '../store/store/tree-op-section-address.js';
