...
import type { OoxmlProperty, TreeDocOp } from '../store/store/tree-ops.js';
import {
  findOccurrences,
  isSearchableQuery,
  SEARCH_MATCH_LIMIT,
} from '../store/store/text-match.js';
import {
  directParagraphMarkProperties,
  directParagraphProperties,
  mergedProperties,
  runPropertyEdits,
} from '../store/store/direct-properties.js';
import {
  fontProperties,
  fontRead,
...
import type { AutomationHandleTable } from './handles.js';
import type {
  AutomationOperation,
  AutomationSearchOptions,
  AutomationSelectionMode,
} from './operations.js';
import { isAutomationCommand, isSolitaryAutomationCommand } from './operations.js';
import type {
...
import { PARAGRAPH_MARK, type AutomationPackageReads, type AutomationStoryReads } from './reads.js';
import {
...
import { BODY_STORY, storyKey, type AutomationStoryId } from './stories.js';
import { isStoryId } from './stories.js';
import { findNode } from '../store/package/ooxml-edit.js';
import { authorableHyperlinkTarget } from '../store/package/hyperlink-part.js';
import {
  bookmarkIn,
  bookmarkReads,
  linkTarget,
...
import { listReads, membershipIn, MAX_LIST_LEVEL, type AutomationListRead } from './lists.js';
import { pageSetupProperties, type AutomationSectionRead } from './sections.js';
import type { NoteKind } from '../store/package/note-nodes.js';
import { paragraphStyleName, styleIdFor } from './styles.js';
import type { StoryScope } from '../store/store/tree-package-store.js';
import type { AutomationCommentWrite } from './document-port.js';
import { commentReads, revisionReads, type AutomationRevisionRead } from './review.js';
import type { ReviewCommentItem } from '../store/store/review-reads.js';
import {
...
import {
  ...
  contentControlsIn,
} from '../store/package/content-control-nodes.js';
import type { ContentControlValueInput } from '../store/store/tree-op-content-controls.js';
import type { InsertCustomNodeWrite } from '../store/store/custom-node-writes.js';
import {
  customNodePayloadOf,
  customNodePlacement,
  customNodeRequestRefusal,
  customNodeWriteOf,
} from './custom-node-plan.js';
import type { OoxmlNode } from '../store/package/ooxml-tree.js';
