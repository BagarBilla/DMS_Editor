...
import { isDrawingKnownKind, validDrawingKnownKind } from './ooxml-drawing-rules.js';
import type { OoxmlAttribute, OoxmlElement, OoxmlNode, OoxmlReadRejection } from './ooxml-tree.js';

export { knownKindAllowsWmlVal } from './ooxml-sdt.js';
