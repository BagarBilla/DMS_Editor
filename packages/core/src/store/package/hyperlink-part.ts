...
import { readOoxmlPart } from './ooxml-tree.js';
import type { OoxmlNode } from './ooxml-tree.js';
import type { OoxmlPackage } from './ooxml-package.js';
import { escapeXmlChecked, isValidXmlText, sanitizeHref } from './sinks.js';
import { validateExternalTarget } from './opc-names.js';
import {
  HYPERLINK_RELATIONSHIP_TYPE,
  hyperlinkRelationshipIdOf,
  isHyperlinkNode,
} from './hyperlink.js';
import { DRAWINGML_MAIN_NAMESPACE_URI, RELATIONSHIPS_NAMESPACE_URI } from './ooxml-tree.js';
