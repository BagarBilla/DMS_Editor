...
import { readXml, type XmlLimits, type XmlNode, type XmlRejection } from './xml-reader.js';
import { isValidNCName } from './qname.js';
import { candidateSdtKind } from './ooxml-sdt.js';
import {
  TreeReadError,
  W14_NAMESPACE_URI,
  WML_NAMESPACE_URI,
...
export {
  ...
  ooxmlTreesEqual,
  serializeOoxmlPart,
} from './ooxml-serialize.js';
export { validateOoxmlPart, validateOoxmlPartDelta } from './ooxml-validate.js';
