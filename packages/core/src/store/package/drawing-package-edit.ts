...
import { removeNode } from './ooxml-edit.js';
import { normalizePartName, partNameKey, resolveInternalTarget } from './opc-names.js';
import {
  sniffImageMime,
...
import { relsPartNameFor, withContentTypeOverride, withRelationship } from './package-edit.js';
import { IMAGE_RELATIONSHIP_TYPE, resolveImageRelationship } from './relationships.js';
import { withoutContentTypeOverride } from './hf-lifecycle-shell.js';
...
import { ST_POSITIVE_COORDINATE_MAX } from './ooxml-drawing-rules.js';
