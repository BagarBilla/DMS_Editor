...
import { hyperlinkAnchorOf } from './hyperlink.js';
import { findNode } from './ooxml-edit.js';
import type { OoxmlNode, OoxmlPart } from './ooxml-tree.js';
import { tocEntryText, type TocOutlineHeading } from './toc-build.js';
import type { DetectedToc } from './toc-detect.js';
