...
import { sanitizeHref } from './sinks.js';
import { HYPERLINK_RELATIONSHIP_TYPE, type RelationshipTargetResolver } from './hyperlink.js';
...
import {
  ...
  type WalkState,
} from './drawing-projection-walk.js';
import {
  MC_NAMESPACE_URI,
  RELATIONSHIPS_NAMESPACE_URI,
  W14_NAMESPACE_URI,
  WML_NAMESPACE_URI,
} from './ooxml-shared.js';
import {
...
} from './drawing-shape-projection.js';

export type { TextboxStoryProjection, VectorShapeProjection } from './drawing-shape-projection.js';
