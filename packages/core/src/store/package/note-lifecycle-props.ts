...
import { createNodeIdAllocator, replaceChildren } from './ooxml-edit.js';
import { readOoxmlPart, type OoxmlNode, type OoxmlPart } from './ooxml-tree.js';
import type { OoxmlPackage } from './ooxml-package.js';
import { withPart } from './ooxml-package.js';
import { WML_NAMESPACE_URI } from './ooxml-shared.js';
import { collectSectionPropertyNodes } from './hf-references.js';
import { freeRelationshipId, withContentTypeOverride } from './note-lifecycle-shell.js';
import { withStoryRelationship } from './hf-lifecycle-shell.js';
import { settingsPartOf } from './note-properties.js';
