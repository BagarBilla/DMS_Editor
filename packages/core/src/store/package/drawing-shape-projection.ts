...
import { findDirectKind, isElement } from './drawing-projection-walk.js';
import { schemaAttributeValue } from './ooxml-drawing-rules.js';
import { WML_NAMESPACE_URI } from './ooxml-shared.js';
import { DRAWINGML_MAIN_NAMESPACE_URI, type OoxmlElement, type OoxmlNode } from './ooxml-tree.js';
