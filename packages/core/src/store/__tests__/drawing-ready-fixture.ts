...
import type { ImageResourceState, SupportedImageMime } from '../package/image-resources.js';
import { registerValidatedImageBytes } from '../package/validated-image-bytes.js';
