...
import { validateTableColumnOp } from '../store/tree-op-tables.js';
import { wmlChildNamed } from '../store/tree-op-table-shared.js';
import { paragraphIdsWithin } from '../store/tree-op-blocks.js';
import { isValidParaId, paraIdOf } from '../package/para-id.js';
import { diffSemanticDigests, semanticDigest } from '../package/ooxml-digest.js';
import { MAX_TABLE_COLUMNS } from '../store/table-constraints.js';
