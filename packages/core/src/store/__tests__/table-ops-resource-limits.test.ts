...
import { readOoxmlPart, WML_NAMESPACE_URI, type OoxmlElement } from '../package/ooxml-tree.js';
...
import { MAX_TABLE_COLUMNS as LAYOUT_MAX_TABLE_COLUMNS } from '../../layout/table-widths.js';
