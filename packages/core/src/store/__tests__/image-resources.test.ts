...
import {
  ...
  TIFF_FIELD_RATIONAL,
  TIFF_FIELD_SHORT,
} from './tiff-test-bytes.js';
import {
  readOoxmlPackage,
  writeOoxmlPackage,
  type OoxmlPackage,
} from '../package/ooxml-package.js';
import { withRelationship } from '../package/package-edit.js';
import { projectDrawingsInPackage } from '../package/drawing-projection.js';
