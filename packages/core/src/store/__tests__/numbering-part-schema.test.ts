...
import { ensureListDefinition, type ListKind } from '../package/numbering-part.js';
import { serializeOoxmlPart } from '../package/ooxml-tree.js';
import type { OoxmlElement, OoxmlNode } from '../package/ooxml-tree.js';
