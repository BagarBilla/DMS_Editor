...
import { validateTableResizeOp } from '../store/tree-op-tables.js';
import { wmlChildNamed } from '../store/tree-op-table-shared.js';
...
import { TreeDocumentStore, type TreeModelChange } from '../store/tree-store.js';
