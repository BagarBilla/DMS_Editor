...
} from '../package/image-resources.js';
import { resolveImageResourceLimits } from '../runtime/limits.js';
import { mockReadyImageResource } from './drawing-ready-fixture.js';
import { createFixedMeasurer, layoutSemanticDocument } from '../../layout/semantic-layout.js';
import type { InlineDrawingLayoutContext } from '../../layout/drawing-layout.js';
import { paintSemanticLayout } from '../../output/semantic-paint.js';
import type { PaintImageUrlPort } from '../../output/semantic-paint-drawings.js';
import { FIXTURE_ORACLES } from './drawing-fixture-oracles.js';
