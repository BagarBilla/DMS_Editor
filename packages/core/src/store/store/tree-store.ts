...
import { validateOoxmlPartDelta, type OoxmlPart } from '../package/ooxml-tree.js';
import { withPart, type OoxmlPackage } from '../package/ooxml-package.js';
import { validatePackageInvariants } from '../package/package-edit.js';
import { settingsPartOf } from '../package/note-properties.js';
import { ORIGIN_IDS } from '../registry/frozen-ids.js';
import { formsProtectionRefusal } from './tree-op-content-controls.js';
import { applyTreeOp, type ImpactClass, type TreeDocOp, type TreeOpRejection } from './tree-ops.js';
