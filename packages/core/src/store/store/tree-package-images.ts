...
import { findNode, replaceNode } from '../package/ooxml-edit.js';
import { withPart } from '../package/ooxml-package.js';
import {
  projectDrawing,
...
import type { PackageTransactResult, StoryScope, TreePackageStore } from './tree-package-store.js';
import type { TransactionContext, TreeDocumentStore } from './tree-store.js';
