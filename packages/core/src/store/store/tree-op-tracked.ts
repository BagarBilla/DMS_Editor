...
import { TEXT_DEPS, fromEdit } from './tree-op-nodes.js';
import { paragraphOffsetIndex, type ParagraphOffsetIndex } from './tree-op-segments.js';
import type { RevisionAttributionInput, TreeOpEffect, TreeOpResult } from './tree-op-validate.js';
