...
import type { OoxmlNode, OoxmlParagraphNode, OoxmlPart } from '../package/ooxml-tree.js';
import { findNode } from '../package/ooxml-edit.js';
import { isValidXmlText } from '../package/sinks.js';
import { isAuthorableDataBinding } from '../package/custom-node-payloads.js';
import { validateDeleteBlock } from './tree-op-blocks.js';
import {
...
import {
  ...
  sectionChild,
  targetSectionNodes,
} from './tree-op-section-address.js';
import { rangePartiallyOverlapsDrawingAtom } from '../package/drawing-projection.js';
import { isDrawingTreeDocOp, validateDrawingOp } from './tree-op-drawings.js';
import {
  isParagraph,
  paragraphLength,
...
import { validateInsertTable } from './tree-op-insert-table.js';
import {
