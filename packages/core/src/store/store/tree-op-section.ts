...
import type { OoxmlProperty, TreeDocOp, TreeOpEffect, TreeOpResult } from './tree-op-types.js';
import {
  TEXT_DEPS,
  cloneWithNewIds,
  fromEdit,
...
import { RUN_VOCABULARY, mergedPropertyChildren } from './tree-op-properties.js';
