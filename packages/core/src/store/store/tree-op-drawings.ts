...
import {
  ...
  type SourceCrop,
} from '../package/drawing-projection.js';
import { validateDrawingPositionInput } from '../package/drawing-position-input.js';
import { ST_POSITIVE_COORDINATE_MAX } from '../package/ooxml-drawing-rules.js';
import { sanitizeHref } from '../package/sinks.js';
import {
...
import { cloneWithNewIds, fromEdit, parentOf, TEXT_DEPS } from './tree-op-nodes.js';
import { insertRunPayloadAtOffset, offsetInsideAtomicSegment } from './tree-op-insert-offset.js';
import { isTableNested } from './tree-op-section-address.js';
import { isParagraph, paragraphLength, segmentsOf, splitsSurrogate } from './tree-op-segments.js';
import type {
  DrawingTreeDocOp,
  ImpactClass,
  TreeDocOp,
