...
import type { OoxmlPart } from '../package/ooxml-tree.js';
import { normalizeParagraphIdentity } from '../package/para-id.js';
import { withPart, type OoxmlExternalTarget, type OoxmlPackage } from '../package/ooxml-package.js';
import { resolveRelationship, type RelationshipRecord } from '../package/relationships.js';
import {
  applyHeaderFooterLifecycleOp,
  isHeaderFooterLifecycleOp,
  type HeaderFooterLifecycleOp,
} from '../package/hf-lifecycle.js';
import {
  applyNoteLifecycleOp,
  cascadeDeletedNoteReferences,
  isNoteLifecycleOp,
  type NoteLifecycleOp,
} from '../package/note-lifecycle.js';
import { resolveNotesPart } from '../package/note-references.js';
import type { NoteKind } from '../package/note-nodes.js';
import {
  mergePersistentPackageShell,
  pruneUnreachableHyperlinkShell,
  rememberShellHyperlinks,
  retainShellHyperlinks,
} from '../package/package-shell-persistence.js';
import { ORIGIN_IDS } from '../registry/frozen-ids.js';
import type { ImpactClass, TreeDocOp, TreeOpRejection } from './tree-ops.js';
import {
  deleteBlockMayStrandNote,
  deleteMayEmptyCommentRange,
  deleteMayStrandNote,
} from './tree-package-gates.js';
import { cascadeEmptiedComments } from '../package/comment-lifecycle.js';
import {
  TreeDocumentStore,
  type SelectionMark,
...
export class TreePackageStore {
  ...
  replaceImage(
    ...
    options: import('./tree-package-images.js').ReplaceImageOptions
