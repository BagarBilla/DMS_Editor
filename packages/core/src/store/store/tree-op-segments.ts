...
import type { OoxmlElement, OoxmlNode, OoxmlParagraphNode } from '../package/ooxml-tree.js';
import {
...
import {
  ...
  isFldSimple,
  isInstrText,
} from '../package/field-nodes.js';
import { atomicNoteSpansOf, isNoteAtomNode } from '../package/note-nodes.js';
