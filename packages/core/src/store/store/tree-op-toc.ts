...
import { detectBodyTocs, findDetectedToc, type DetectedToc } from '../package/toc-detect.js';
import {
  bookmarkPairNodes,
  buildTocContentControl,
  buildTocEntryParagraph,
  type TocEntryPlan,
} from '../package/toc-build.js';
import { parseTocInstruction, TOC_MAX_ENTRIES } from '../package/toc-instruction.js';
import {
...
import type { OoxmlElement, OoxmlNode, OoxmlPart } from '../package/ooxml-tree.js';
import {
...
import type { TreeDocOp, TreeOpEffect, TreeOpRejection, TreeOpResult } from './tree-op-types.js';
