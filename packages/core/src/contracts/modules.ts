...
import type { ReviewItem, ReviewModelInput, ReviewRevisionItem } from '../layout/review-support.js';
...
export type { RevisionDisplayMode } from '../layout/revision-projection.js';
