...
import type { ContentControlSummary, DocEdits, DocQueries, DocQueryResults } from './document.js';
...
import type {
  ...
  ReviewRevisionItem,
  ReviewRevisionKind,
} from '../layout/review-support.js';
import type { InteractionOutcome } from './interaction.js';
...
import type { SemanticPosition, SemanticSelection } from '../layout/semantic-interaction.js';
import type {
  ColorValue,
...
import type { ImageCropPercent } from '../store/package/image-crop-units.js';
import type { ImageResourceState, SupportedImageMime } from '../store/package/image-resources.js';

export type * from './types.js';
export type * from './interaction.js';
export type * from './editor-hf-notes.js';
export type { ImageCropPercent } from '../store/package/image-crop-units.js';
...
export type { SemanticPosition, SemanticSelection } from '../layout/semantic-interaction.js';
export type {
