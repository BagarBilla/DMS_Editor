...
} from '../src/components/PaginatedDocxEditor.js';
import type { PaginatedDocxEditorExpose } from '../../vue/src/components/PaginatedDocxEditor.js';
...
const { PaginatedDocxEditor: VueHost } = await import(
  '../../vue/src/components/PaginatedDocxEditor.js'
);
