import { i as Fragment, p as Slice } from "./dist-CQO0FW0S.js";
import { _ as liftTarget, c as TextSelection, d as ReplaceStep, f as canJoin, g as joinPoint, h as findWrapping, o as Selection, p as canSplit, r as NodeSelection, s as SelectionRange, t as AllSelection, u as ReplaceAroundStep, v as replaceStep } from "./dist-CGR6YLow.js";
//#region ../../node_modules/.bun/prosemirror-commands@1.7.1/node_modules/prosemirror-commands/dist/index.js
/**
...
function wrapDispatchForJoin(dispatch, isJoinable) {
	return (tr) => {
		...
		for (let i = joinable.length - 1; i >= 0; i--) if (canJoin(tr.doc, joinable[i])) tr.join(joinable[i]);
		dispatch(tr);
	};
}
/**
